-- da3be4aba4fbcc8267dac7202ee01442 http://api.2445580392072.proxy.3scale.net:80 http://okmail.herokuapp.com:80 2555417687612 okmail.herokuapp.com http://pokeAPI.2445580392072.proxy.3scale.net:80 https://hello-world-api.3scale.net:443 2555417687722 hello-world-api.3scale.net http://okmail.2445580392072.proxy.3scale.net:80 http://okmail.herokuapp.com:80 2555417687932 okmail.herokuapp.com http://azuresentimentapi2.2445580392072.proxy.3scale.net:80 http://az3scale.cloudapp.net:80 2555417703952 az3scale.cloudapp.net --
-- -*- mode: lua; -*-
-- Generated on: 2014-04-02 18:21:02 +0000 --
-- Version:
...
function get_debug_value()
   ...
   if h["X-3scale-debug"] == 'da3be4aba4fbcc8267dac7202ee01442' then
      return true
   else
      return false
   end
...
local service = {}
      if ngx.var.service_id == '2555417687612' then
        ...
        ngx.var.secret_token = service.secret_token
              params.user_key = parameters["app_key"]
        get_credentials_user_key(params , service_2555417687612)
        ngx.var.cached_key = "2555417687612" .. ":" .. params.user_key
              auth_strat = "1"
